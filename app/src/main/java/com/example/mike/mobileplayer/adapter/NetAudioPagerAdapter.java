...
public class NetAudioPagerAdapter extends BaseAdapter {
    ...
    private final List<NetAudioBean.ListBean> mDatas;
    private Utils utils;

    public NetAudioPagerAdapter(Context context, List<NetAudioBean.ListBean> datas){
    ...
    public int getItemViewType(int position) {
        ...
        NetAudioBean.ListBean listBean = mDatas.get(position);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //绑定数据
        //根据位置得到数据,绑定数据
        NetAudioBean.ListBean mediaItem = mDatas.get(position);
        bindData(itemViewType, viewHolder, mediaItem);

        return  convertView;
    }

    private void bindData(int itemViewType,ViewHolder viewHolder, NetAudioBean.ListBean mediaItem) {
